...
export const RecommendationCard = ({
  ...
  return (
    <div
      className={cn(
        isResult
          ? "h-[421px] w-[302px] bg-gray-100"
          : "h-[438px] w-[280px] scale-100 bg-white active:scale-95 active:transition-all active:duration-300 active:ease-in-out",
        "cursor-pointer select-none rounded-2xl p-4",
      )}
    >
      <motion.div
