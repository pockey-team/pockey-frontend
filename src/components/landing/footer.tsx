...
export const FooterSection = () => {
  return (
    <div className="bg-gray-900 py-[96px]">
      <motion.div
      ...
      >
        <h1 className="text-subtitle-18-semibold md:text-heading-24-semibold lg:text-display-32-semibold">
          딱 맞는 선물, 포키에서
        </h1>
        ...
        <Button
          asChild
          className="hover:!bg-primary-500/80 !text-gray-900 !rounded-md mt-[28px] h-[50px] w-[280px] bg-primary-500 sm:h-52px sm:w-[358px]"
        >
